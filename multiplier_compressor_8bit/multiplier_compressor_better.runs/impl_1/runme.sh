...
HD_PWD='D:/CAD PROJECT/multiplier_compressor_better/multiplier_compressor_better.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log multiplier_conventional.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source multiplier_conventional.tcl -notrace
