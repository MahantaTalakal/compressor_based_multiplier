...
HD_PWD='D:/CAD PROJECT/multiplier_compressor_better/multiplier_compressor_better.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log multiplier_conventional.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source multiplier_conventional.tcl
